...
export function showMinigamesList(container) {
    ...
    container.innerHTML = `
        <div id="lobby-wrapper" class="fade-in" style="color: white; width: 100%;">
            <div class="dashboard-container" style="padding: 20px; padding-bottom: 140px;">
                
                <div style="display: flex; justify-content: flex-start; align-items: center; margin-bottom: 20px;">
                    <button id="btn-back-main" class="btn-back-glass" style="width: auto; padding: 12px 24px; border-radius: 50px;">
                        ← TORNA ALLA LIBRERIA
                    </button>
                </div>
                ...
                <header style="margin: 10px 0 30px 0; text-align: center;">
                    ...
                    <h1 class="main-title" style="margin: 0; font-size: 2.8rem;">MINI <span style="color: #9d4ede;">GIOCHI</span></h1>
                </header>

                <div class="grid-layout">
                    ${games.map(game => `
                        <div class="game-card" id="btn-${game.id}" style="background: ${game.color}; min-height: 140px; justify-content: center;">
