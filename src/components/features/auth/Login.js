...
export function showLogin(container) {
    ...
    <div class="auth-wrapper" style="display: flex; align-items: center; justify-content: center; min-height: 80vh; padding: 20px;">
        <div class="glass-box" style="width: 100%; max-width: 380px; padding: 40px 30px;">
            ...
            <div style="margin: 25px 0; display: flex; align-items: center; gap: 10px; opacity: 0.3;">
                <hr style="flex-grow:1; border: 0.5px solid var(--amethyst-bright);"><span style="font-size: 10px;">OPPURE</span><hr style="flex-grow:1; border: 0.5px solid var(--amethyst-bright);">
            </div>
            <button id="discord-login" class="btn-primary" style="background:#5865F2; border:none; width:100%; display:flex; align-items:center; justify-content:center; gap:12px;">
    ...
    // Inizializza il tasto Discord caricando la funzione da Discord.js
    import('./Discord.js').then(m => m.initDiscord());
